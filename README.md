...
1. Short & Aggressive Offers (e.g., BUY NOW!) are flagged 75%+ spam.
2. Casual Conversations (e.g., "Hi, how are you?") are almost never spam.
3. Scam Messages (e.g., "You have won a free trip!") are 99% spam.
